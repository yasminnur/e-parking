...
export default function ScanTiketKeluar() {
  ...
  const handleSesuaiPress = () => {
    navigation.navigate("Scan Tiket"); // Mengarahkan ke halaman PilihTiket
  };
  ...
  return (
    <>
      <ScrollView >
      <View style={{ flex: 1, display: "flex", flexDirection: "row", alignItems: "center", paddingTop: 50, paddingBottom: 25, paddingHorizontal: 20, backgroundColor: 'white'}} >
          <TouchableOpacity onPress={handleBack}><Arrow /></TouchableOpacity>
          <Text style={{  textAlign: "center", flex: 1, fontSize: 16, fontWeight: 'bold' }}>Scan Tiket Keluar</Text>
        </View>
        ...
        >
          <TouchableOpacity
            style={[styles.button, { backgroundColor: "#269544" }]}
            onPress={handleSesuaiPress}
          >
            <Text style={ { color: "white" }}>Sesuai</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.button, { backgroundColor: "#952626" }]}
            onPress={handleTidakSesuaiPress}
          >
            <Text style={ { color: "white" }}>Tidak Sesuai</Text>
          </TouchableOpacity>
          </View>
          </View>
      </ScrollView>
